    ...
    public function postAutofillpemeriksaan()
    {
      ...
      if (!empty($current)) {
        ...
        if ($status_poli == 'Lama') {
          ...
          $sql = "SELECT p.tensi, p.suhu_tubuh, p.nadi, p.respirasi, p.tinggi, p.berat, p.kesadaran, p.spo2, p.gcs, p.alergi, p.keluhan, p.pemeriksaan, p.penilaian, p.rtl, p.tgl_perawatan, p.jam_rawat, p.no_rawat, p.nip
